...
void single_park::draw(){
    ...
    double axis_points[6][2] = {{-30.0,-10.0}, {-30.0,110.0}, {20.0*(double)slot_num/2+30.0,110.0}, {20.0*(double)slot_num/2+30.0,0.0}, {0.0,0.0}, {0.0,-10.0}};
    ...
    double barrier_index[4][2] = {{10.0,50.0},{10.0,60.0}, {20.0*(double)slot_num/2-10.0,60.0}, {20.0*(double)slot_num/2-10.0,50.0}};
